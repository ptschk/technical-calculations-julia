...
println()
println("Таблиця похибок для різних сіток методом Гаусса-Зейделя:")
println("----------------------------------------------------------------")
...
heatmap(
    ...
    xlabel = "x",
    ylabel = "y",
    title = "Рівняння Лапласа: heatmap",
...
surface(
    ...
    ylabel = "y",
    zlabel = "u(x,y)",
    title = "Рівняння Лапласа: surface plot"
)
...
contour(
    ...
    xlabel = "x",
    ylabel = "y",
    title = "Рівняння Лапласа: contour plot",
    fill = true,
    colorbar_title = "u(x,y)"
)
